...
window.addEventListener("load", function () { bamboo.setContext(window, XMLHttpRequest, null, null, DOMParser, XMLSerializer, null, Notification); bamboo.init(); }, false);
window.addEventListener("focus", function () { bamboo.setContext(window, XMLHttpRequest, null, null, DOMParser, XMLSerializer, null, Notification); }, true);
