...
if (window.location.href.indexOf("//www.baidu.com/") != -1) {
	...
	if (document.getElementById("u_sp") && document.getElementById("s_username_top")) {
		document.getElementById("s_icons").insertBefore(newEm, document.getElementById("s_icons").lastChild);
		document.getElementById("s_icons").insertBefore(autoSignbox, document.getElementById("s_icons").lastChild);
