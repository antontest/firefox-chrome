// ==UserScript==
// @name           searchEngineJump modified version from NLF
// @author         NLF&锐经(修改)
// @description    方便的在各个搜索引擎之间跳转
// @version        4.0.4.7
// @created        2011-7-2
// @lastUpdated    2016-4-3
// @grant          none
...
(function () {
	...
	/* 					keyword: function () {
				...
				{name: "baidu网页搜索",
					...
					style: '\
						...
						border-bottom:0px solid #D9E1F7;\
						margin-top:-1px;\
					',
					insertIntoDoc: {
    ...
    {name: "搜狗音乐",
        ...
        insertIntoDoc: {
           ...
           where:'beforeBegin',
			...
			engineList.web[0] = {
				...
				name: 'Google',
				// 搜索引擎地址，关键字变量用%s代替
				url: 'https://www.google.com.hk/search?q=%s&ie=utf-8&oe=utf-8',
				// 搜索引擎的站点图标
			...
			engineList.web[5] = {
				...
				favicon: 'data:image/png;base64,',
			};
			engineList.web[-6] = {
				name: '搜搜',
				url: 'http://www.soso.com/q?query=%s&utf-8=ie',
				favicon: 'data:image/png;base64,',
			};
			engineList.web[7] = {
				name: '搜狗',
			...
			engineList.image[0] = {
				name: '谷歌图片',
				url: 'https://www.google.com.hk/search?q=%s&tbm=isch',
				favicon: 'data:image/png;base64,',
			};
			engineList.image[1] = {
				name: '百度图片',
			...
			engineList.image[5] = {
				...
				favicon: 'data:image/png;base64,',
			};
			engineList.image[6] = {
				name: '花瓣',
			...
			engineList.image[7] = {
				...
				favicon: 'data:image/png;base64,',
			};
			...
			engineList.download[0] = {
				...
				favicon: 'data:image/png;base64,',
			};
			engineList.download[1] = {
				name: '网盘搜索',
				url: 'http://so.baiduyun.me/search.php?wd=%s',
				favicon: 'data:image/png;base64,',
			};
			engineList.download[2] = {
				name: '天天网盘',
				url: 'https://so.cqp.cc/search?w=%s',
				favicon: 'data:image/png;base64,',
			};
			engineList.download[3] = {
				name: '极影动漫',
				url: 'http://bt.ktxp.com/search.php?keyword=%s',
				favicon: 'data:image/png;base64,',
			};
			engineList.download[4] = {
				name: '动漫花园',
				url: 'http://share.dmhy.org/topics/list?keyword=%s',
				favicon: 'data:image/png;base64,',
			};
			...
			engineList.download[6] = {
				...
				favicon: 'data:image/png;base64,',
			};
			...
			engineList.shopping[3] = {
				...
				favicon: 'data:image/png;base64,',
				encoding: 'gbk',
			};
			...
			engineList.shopping[6] = {
				name: '美团',
				url: 'http://dl.meituan.com/s/?w=%s',
				favicon: 'data:image/png;base64,',
			};
			...
			engineList.shopping[9] = {
				name: '嗨淘全球',
				url: 'http://hitao.top/goods/search?keyword=%s',
				favicon: 'data:image/png;base64,',
			};
        ...
        favicon: 'data:image/png;base64,',
			...
			engineList.mine[0] = {
				name: '漫步天涯',
				url: 'http://lihuiyuan.summerhost.info/?s=%s',
				favicon: 'data:image/png;base64,',
			};
			engineList.mine[1] = {
				name: '爱我吧',
				url: 'http://i58.summerhost.info/?s=%s',
				favicon: 'data:image/png;base64,',
			};
			...
			engineList.details[4] = ['学术', 'scholar'];
			//engineList.details[5] = ['自用', 'mine'];
			engineList.details[6] = ['知识', 'knowledge'];
			engineList.details[7] = ['下载', 'download'];
			engineList.details[8] = ['社交', 'sociality'];
			engineList.details[9] = ['翻译', 'translate'];
